...
This page explains why each major external library exists in the project
and links to its official documentation.

## Runtime libraries

- [React](https://react.dev/): builds the component-based user interface.
...
- [Vitest](https://vitest.dev/guide/): runs unit and component tests.
...
- [VitePress](https://vitepress.dev/guide/what-is-vitepress):
  powers the serveable documentation site.
- [DokuWiki](https://github.com/dokuwiki/dokuwiki): powers the separate
  beginner-friendly wiki layer.
