...
GitHub security advisories or your organization's
responsible disclosure channel. Avoid opening public
...
- Repository policy tests validate that critical
  governance files remain in place.
- Documentation explains how logging works so debugging
  does not encourage unsafe ad hoc instrumentation.
